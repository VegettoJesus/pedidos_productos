    ...
    */
    ...
    'configs' => [
        'default' => [
            ...
            'HTML.Allowed' => 'p[style],span[style],div[style],br,strong[style],em[style],u[style],s[style],del[style],ul[style],ol[style],li[style],a[href|title|style],blockquote[style],pre[style],code[style],h1[style],h2[style],h3[style],h4[style],h5[style],h6[style]',
            'HTML.AllowedAttributes' => '*.style,*.class,*.id,*.data-*',
            'HTML.ForbiddenElements' => 'script,style,img', // ← Agregado 'img'
            'HTML.Trusted' => true,
