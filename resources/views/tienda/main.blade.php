    ...
    <h1>Bienvenido a <span class="highlight">{{ $titulo_site ?: 'EMPRESA' }}</span></h1>
        ...
        <div class="products">
            <div class="product-card">
                <div class="product-img">Laptop Gaming Pro</div>
            ...
            <div class="product-card">
                <div class="product-img">Smartphone Ultra 5G</div>
                <div class="product-info">
                    <h3 class="product-title">Smartphone Ultra 5G</h3>
                    <p class="product-price">$899.99</p>
                </div>
            </div>
            
            <div class="product-card">
                <div class="product-img">Tablet Profesional</div>
                <div class="product-info">
                    <h3 class="product-title">Tablet Profesional</h3>
                    <p class="product-price">$649.99</p>
                </div>
            </div>
            
            <div class="product-card">
                <div class="product-img">Smart Watch Pro</div>
                <div class="product-info">
